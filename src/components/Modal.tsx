...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      <button type="button" className="absolute inset-0 bg-navy/45 backdrop-blur-sm" onClick={onClose} />
      <div
        className={`relative flex w-full flex-col overflow-hidden rounded-[8px] border border-line bg-white shadow-2xl ${
